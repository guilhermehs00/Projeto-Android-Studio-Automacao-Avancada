...
public class Reconciliation {
    ...
    public String printMatrix(double[] _m) {
        if (_m != null) {
            DecimalFormat df = new DecimalFormat("#.###"); // Formato para 3 casas decimais
            StringBuilder vetor = new StringBuilder();

            for (double value : _m) {
                vetor.append(df.format(value)).append("\n");
            }

            return vetor.toString();
        } else {
            return "A matriz tem dados nulos.";
        }
    }
